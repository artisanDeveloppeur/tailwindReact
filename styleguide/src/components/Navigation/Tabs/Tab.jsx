                ...
                <div className="flex flex-col flex-wrap rounded-lg border border-[#E4E4E4] px-4 py-3 dark:border-dark-3 sm:flex-row">
                  <a
                    ...
                    className={`cursor-pointer rounded-md px-4 py-3 text-sm font-medium md:text-base lg:px-6 ${open === "home"
                      ...
                      : "text-body-color hover:bg-primary hover:text-blue-600	"
                      }`}
                  >
                    Home
                  </a>
                  ...
                  <a
                    ...
                    className={`cursor-pointer rounded-md px-4 py-3 text-sm font-medium md:text-base lg:px-6 ${open === "company"
                      ? "bg-primary text-blue-600"
                      : "text-body-color hover:bg-primary hover:text-blue-600	"
                      }`}
                  >
...
const TabContent = ({ open, tabCategory, details }) => {
  return (
    <div>
      <div
        className={`p-6 text-base leading-relaxed text-body-color ${open === tabCategory ? "block" : "hidden"
          } `}
      >
        {details}
      </div>
